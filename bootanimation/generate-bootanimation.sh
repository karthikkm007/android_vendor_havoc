...
tar xfp "vendor/havoc/bootanimation/bootanimation$RANDOM_BOOT.tar" --to-command="convert - -resize '$RESOLUTION' -colors 250 \"png8:$OUT/bootanimation/\$TAR_FILENAME\""

# Create desc.txt
echo "$SIZE $SIZE" 30 > "$OUT/bootanimation/desc.txt"
cat "vendor/havoc/bootanimation/desc.txt" >> "$OUT/bootanimation/desc.txt"
